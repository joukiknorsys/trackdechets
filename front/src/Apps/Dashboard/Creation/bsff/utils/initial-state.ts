...
export type CreateOrUpdateBsffDentainerInput = BsffDentainerInput & {
  id?: string | null;
  takenOverAt?: string | null;
};

export type BsffValues = Omit<BsffInput, "transporters"> & {
  transporters: CreateOrUpdateBsffDentainerInput[];
} & { id?: string | null };
...
export default {
  ...
  forwarding: null,
  intermediaries: null,
  type: BsffType.OtherCollections
};
